...
![](C:/Users/User/OneDrive%20-%20unb.br/Documentos/Manipula%C3%A7%C3%A3o%20de%20imagens/images/vebi.jpg){width="100%"}
...
![](C:/Users/User/OneDrive%20-%20unb.br/Documentos/Manipula%C3%A7%C3%A3o%20de%20imagens/images/leitura.png){width="100%"}
...
![](C:/Users/User/OneDrive%20-%20unb.br/Documentos/Manipula%C3%A7%C3%A3o%20de%20imagens/images/resize.png){width="100%"}
...
```{r, echo=FALSE}
library("imager")
ocean<- file.path("f:\\users\\rafay\\desktop\\Trabalho\\R\\CE2\\2022\\Trabalho 1\\Manipulacao-de-imagens\\images\\ocean.jpg")
plot(ocean)
```
...
ocn <- load.image(ocean) %>% imresize(.5)
...
```{r, echo=TRUE, message=FALSE, warning=FALSE, paged.print=T}
...
acr <- load.image("f:\\users\\rafay\\desktop\\Trabalho\\R\\CE2\\2022\\Trabalho 1\\Manipulacao-de-imagens\\images\\acropolis.jpg")
